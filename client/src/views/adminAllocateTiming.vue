...
import { fetchVenuesByName, addTiming } from "../api";
...
export default {
  ...
  methods: {
        ...
        allocateTiming(){
            ...
            addTiming(this.user.auth_token, timing)
                .then(async res => {
...
<div class="body container vh-100">
    ...
    <div class="offcanvas offcanvas-bottom" tabindex="-1" id="chShowCanvas" 
    aria-labelledby="offcanvasBottomLabel" style="min-height: 85%;">
        ...
        <div class="offcanvas-body">
            <div id="searchBar">
                <div class="row">
                    ...
                    <div class="col-4">
                        <button class="btn btn-sm btn-outline-success" type="button" @click="load_venues_by_name">Search</button>
                ...
                <div class="col" v-for="venue in searchVenues">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-text mt-3">
                            <p class="badge bg-success text-white"> Location: {{ venue.location }} , {{ venue.city }}</p>
          ...
          <form class="mt-4" onsubmit="return false;">  
            ...
            <div class="row mb-3">
                <div class="col-12 col-sm-10">
                    <div class="input-group input-group-md mb-3">
                        ...
                        placeholder="Not choosen" v-model="show.name" aria-label="Show Name" readonly required>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-12 col-sm-10">
                    <div class="input-group input-group-md mb-3">
                        ...
                        id="venueName" v-model="venueChoosen.name" aria-label="venueName" readonly>
                    </div>
                </div>
                <div class="col-12 col-sm-2">
                        <button type="button" class="btn btn-success btn-md"
                        style="padding-left: 2.5rem; padding-right: 2.5rem;" 
                        data-bs-toggle="offcanvas" data-bs-target="#chShowCanvas" aria-controls="chShowCanvas">Choose Venue</button>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-10">
                    <div class="input-group input-group-md mb-3">
                        ...
                        id="showReleaseDate" aria-label="Show Release Date" min="{{ curDate }}" v-model="date" required>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-10">
                    <div class="input-group input-group-md mb-3">
                        ...
                        id="showReleaseTime" min="06:00" max="23:00" v-model="time" required>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-12 col-sm-8">
                    <div class="input-group input-group-md mb-3">
                        ...
                        <input type="number" class="form-control" name="allocSeats" min="10"
                        id="allocSeats" aria-label="allocSeats" v-model="seats" required>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-10">
                    <div class="input-group input-group-md mb-3">
                        ...
                        id="showTicketPrice" placeholder="450.00" v-model="price" aria-label="Show Ticket Price" required>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-6">
                    ...
                    style="padding-left: 2.5rem; padding-right: 2.5rem;" @click="allocateTiming">Allocate Show Timings</button>
                </div>
                <div class="col-6">
                    <button class="btn btn-success btn-md"
                    style="padding-left: 2.5rem; padding-right: 2.5rem;" @click="addMore">Add More timings</button>
                </div>
            </div>
          </form>
        </div>
